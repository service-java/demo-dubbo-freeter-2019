...
public class SysUserServiceImpl extends ServiceImpl<SysUserDao, SysUserEntity> implements SysUserService {
	...
	public PageUtils queryPage(PageInfo pageInfo,SysUserModel sysUserModel) {
		...
		Page<SysUserEntity> page = this.selectPage(
			pageInfo.getPage(),
			ew.addFilterIfNeed( ThreadContainer.get(Constant.SQL_FILTER)!=null, ThreadContainer.get(Constant.SQL_FILTER) )
		);
	...
	@Override
	public void captcha(String key,String text) {
		// TODO Auto-generated method stub
		 //保存到shiro session
        ShiroUtils.setSessionAttribute(key, text);
	...
	public String getKaptcha(String key) {
		// TODO Auto-generated method stub
		String kaptcha = ShiroUtils.getKaptcha(key);
		return kaptcha;
	}
